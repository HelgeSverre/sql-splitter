...
| **DuckDB (Parquet)**   | 12h     | ⭐ High impact  | 🟡 Designed    | v1.21.0 |
| **Great Expectations** | 16h     | ⭐ High impact  | 🟡 Designed    | v1.22.0 |
| **Atlas**              | 20h     | ⭐ High impact  | 🟡 Designed    | v1.23.0 |
| **dbt**                | 28h     | 🔥 Game-changer | 🟡 Designed    | v1.24.0 |
...
# Export to Parquet (❌ not yet — v1.21.0 target)
...
- **Complements migrate feature**: Extends the migrate feature (v1.19.0) with formal schema versioning
...
### Phase 1: Foundation (v1.21.0 - v1.24.0)

> Note: v1.13.x/v1.14.x shipped as maintenance and polish releases. Core roadmap
> features now sit at: v1.16.0 (Zip Input), v1.17.0 (`generate`), v1.18.0 (Enum Conversion),
> v1.19.0 (Migrate), and v1.20.0 (DBML). These integrations follow after.

**Timeline**: 2 months (76 hours remaining)

| Version | Feature                        | Effort | Priority |
| ------- | ------------------------------ | ------ | -------- |
| v1.21.0 | DuckDB Parquet export          | 12h    | High     |
| v1.22.0 | Great Expectations Integration | 16h    | High     |
| v1.23.0 | Atlas Integration              | 20h    | High     |
| v1.24.0 | dbt Integration                | 28h    | Critical |
...
### Phase 2: Enhancements (v1.24.0 - v1.25.0)

**Timeline**: 2 months (48 hours)

| Version | Enhancement                                       | Effort |
| ------- | ------------------------------------------------- | ------ |
| v1.24.0 | GX native validator + suite diffing               | 16h    |
| v1.25.0 | Atlas bidirectional sync + dbt incremental models | 32h    |

> Parquet export was moved to Phase 1 (v1.21.0) since it extends the already-shipped
...
3. 🚀 **Add Parquet export** (v1.21.0, extends existing DuckDB work)
...
**Strategic Vision**: By v1.24.0, sql-splitter becomes the **universal bridge** between legacy dumps and modern data infrastructure—essential for any team managing databases at scale.
