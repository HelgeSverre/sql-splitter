...
impl StreamingGenerator {
    ...
    fn write_schema<W: Write>(&mut self, w: &mut W) -> io::Result<()> {
        ...
        for t in 0..self.config.num_tables {
            ...
            writeln!(w, "  {}name{} VARCHAR(100),", q_open, q_close)?;
            writeln!(w, "  {}value{} INTEGER,", q_open, q_close)?;
            write!(w, "  {}description{} TEXT", q_open, q_close)?;

            if t > 0 && self.config.include_fk {
                let parent_table = format!("table_{:03}", t - 1);
                writeln!(w, ",")?;
                write!(w, "  {}parent_id{} INTEGER", q_open, q_close)?;
    ...
    fn write_insert_batch<W: Write>(
        ...
        for row_idx in batch_start..batch_end {
            ...
            let escaped_desc = self.escape_string(&desc);
...
impl MultiTenantGenerator {
    ...
    fn write_all_schemas<W: Write>(&self, w: &mut W) -> io::Result<()> {
        ...
        for (table_name, columns, pk_def) in schemas {
            writeln!(w, "CREATE TABLE {}{}{} (", q, table_name, q)?;
            for (i, (col_name, col_type)) in columns.iter().enumerate() {
                let comma = if i < columns.len() - 1 || !pk_def.is_empty() { "," } else { "" };
                writeln!(w, "  {}{}{} {}{}", q, col_name, q, col_type, comma)?;
            }
            if !pk_def.is_empty() {
                writeln!(w, "  {}", pk_def)?;
            }
    ...
    fn get_table_schemas(&self) -> Vec<(&'static str, Vec<(&'static str, &'static str)>, &'static str)> {
        ...
        let decimal_type = match self.config.dialect {
            Dialect::MySql | Dialect::Postgres => "DECIMAL(10,2)",
            Dialect::Sqlite => "REAL",
        };
        ...
        vec![
            ("permissions", vec![("id", int_pk), ("name", "VARCHAR(100)"), ("description", "TEXT")], ""),
            ("roles", vec![("id", int_pk), ("tenant_id", int_type), ("name", "VARCHAR(100)"), ("is_system", bool_type), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("role_permissions", vec![("role_id", int_type), ("permission_id", int_type)], "PRIMARY KEY (role_id, permission_id)"),
            ("currencies", vec![("id", int_pk), ("code", "VARCHAR(3)"), ("name", "VARCHAR(50)"), ("symbol", "VARCHAR(5)")], ""),
            ("tenants", vec![("id", int_pk), ("name", "VARCHAR(255)"), ("slug", "VARCHAR(100)"), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("users", vec![("id", int_pk), ("tenant_id", int_type), ("email", "VARCHAR(255)"), ("name", "VARCHAR(255)"), ("role", "VARCHAR(50)"), ("active", bool_type), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("user_roles", vec![("user_id", int_type), ("role_id", int_type)], "PRIMARY KEY (user_id, role_id)"),
            ("categories", vec![("id", int_pk), ("tenant_id", int_type), ("parent_id", int_type), ("name", "VARCHAR(100)"), ("level", int_type), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("products", vec![("id", int_pk), ("tenant_id", int_type), ("category_id", int_type), ("sku", "VARCHAR(50)"), ("name", "VARCHAR(255)"), ("price", decimal_type), ("active", bool_type), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("customers", vec![("id", int_pk), ("tenant_id", int_type), ("name", "VARCHAR(255)"), ("email", "VARCHAR(255)"), ("phone", "VARCHAR(50)"), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("orders", vec![("id", int_pk), ("tenant_id", int_type), ("customer_id", int_type), ("order_number", "VARCHAR(50)"), ("status", "VARCHAR(20)"), ("total", decimal_type), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("order_items", vec![("id", int_pk), ("order_id", int_type), ("product_id", int_type), ("quantity", int_type), ("unit_price", decimal_type)], ""),
            ("projects", vec![("id", int_pk), ("tenant_id", int_type), ("owner_id", int_type), ("name", "VARCHAR(255)"), ("status", "VARCHAR(20)"), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("tasks", vec![("id", int_pk), ("tenant_id", int_type), ("project_id", int_type), ("assignee_id", int_type), ("title", "VARCHAR(255)"), ("priority", int_type), ("completed", bool_type), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("folders", vec![("id", int_pk), ("tenant_id", int_type), ("parent_id", int_type), ("name", "VARCHAR(255)"), ("path", "VARCHAR(1000)"), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
            ("comments", vec![("id", int_pk), ("tenant_id", int_type), ("parent_id", int_type), ("user_id", int_type), ("commentable_type", "VARCHAR(50)"), ("commentable_id", int_type), ("body", "TEXT"), ("created_at", datetime_type), ("updated_at", datetime_type)], ""),
        ]
    }
    ...
    fn write_permissions<W: Write>(&mut self, w: &mut W) -> io::Result<()> {
        ...
        writeln!(w, "INSERT INTO {}permissions{} ({}id{}, {}name{}, {}description{}) VALUES", 
            q, q, q, q, q, q, q, q)?;
        ...
        for (i, name) in perms.iter().enumerate() {
            ...
            writeln!(w, "({}, '{}', '{}'){}", id, name, self.escape_string(&desc), comma)?;
        }
        writeln!(w)?;
        Ok(())
    }
    ...
    fn write_roles_global<W: Write>(&mut self, w: &mut W) -> io::Result<()> {
        ...
        writeln!(w, "INSERT INTO {}roles{} ({}id{}, {}tenant_id{}, {}name{}, {}is_system{}, {}created_at{}, {}updated_at{}) VALUES",
        ...
        for (i, name) in roles.iter().enumerate() {
            ...
            writeln!(w, "({}, NULL, '{}', {}, '{}', '{}'){}", id, name, bool_val, created, created, comma)?;
        }
        writeln!(w)?;
        Ok(())
    }
    ...
    fn write_role_permissions<W: Write>(&mut self, w: &mut W) -> io::Result<()> {
        ...
        writeln!(w, "INSERT INTO {}role_permissions{} ({}role_id{}, {}permission_id{}) VALUES",
            q, q, q, q, q, q)?;
    ...
    fn write_currencies<W: Write>(&mut self, w: &mut W) -> io::Result<()> {
        ...
        writeln!(w, "INSERT INTO {}currencies{} ({}id{}, {}code{}, {}name{}, {}symbol{}) VALUES",
            q, q, q, q, q, q, q, q, q, q)?;
        ...
        for (i, (code, name, symbol)) in currencies.iter().enumerate() {
            ...
            writeln!(w, "({}, '{}', '{}', '{}'){}", id, code, name, symbol, comma)?;
        }
        writeln!(w)?;
        Ok(())
    }
    ...
    fn write_tenants<W: Write>(&mut self, w: &mut W) -> io::Result<()> {
        ...
        writeln!(w, "INSERT INTO {}tenants{} ({}id{}, {}name{}, {}slug{}, {}created_at{}, {}updated_at{}) VALUES",
        ...
        for i in 0..count {
            ...
            writeln!(w, "({}, '{}', '{}', '{}', '{}'){}", 
                id, self.escape_string(&name), self.escape_string(&slug), created, created, comma)?;
        }
        writeln!(w)?;
        Ok(())
    }
    ...
    fn write_users<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for _ in 0..users_per_tenant {
                ...
                batch.push(format!("({}, {}, '{}', '{}', '{}', {}, '{}', '{}')",
                    id, tenant_id, self.escape_string(&email), self.escape_string(&name), 
                    role, active, created, created));
    ...
    fn write_user_roles<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        writeln!(w, "INSERT INTO {}user_roles{} ({}user_id{}, {}role_id{}) VALUES",
            q, q, q, q, q, q)?;
    ...
    fn write_categories<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for i in 0..cats_per_tenant {
                ...
                batch.push(format!("({}, {}, {}, '{}', {}, '{}', '{}')",
                    id, tenant_id, parent_id, self.escape_string(&name), level, created, created));
    ...
    fn write_products<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for _ in 0..prods_per_tenant {
                ...
                batch.push(format!("({}, {}, {}, '{}', '{}', {:.2}, {}, '{}', '{}')",
                    id, tenant_id, cat_id, self.escape_string(&sku), self.escape_string(&name),
                    price, active, created, created));
    ...
    fn write_customers<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for _ in 0..custs_per_tenant {
                ...
                batch.push(format!("({}, {}, '{}', '{}', '{}', '{}', '{}')",
                    id, tenant_id, self.escape_string(&name), self.escape_string(&email),
                    self.escape_string(&phone), created, created));
    ...
    fn write_orders<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for _ in 0..orders_per_tenant {
                ...
                batch.push(format!("({}, {}, {}, '{}', '{}', {:.2}, '{}', '{}')",
                    id, tenant_id, cust_id, self.escape_string(&order_num), status,
                    total_amt, created, created));
    ...
    fn write_projects<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for _ in 0..projs_per_tenant {
                ...
                batch.push(format!("({}, {}, {}, '{}', '{}', '{}', '{}')",
                    id, tenant_id, owner_id, self.escape_string(&name), status, created, created));
        ...
        for &tenant_id in tenant_ids {
            ...
            for &proj_id in &proj_ids {
                for _ in 0..tasks_per_project {
                    ...
                    batch.push(format!("({}, {}, {}, {}, '{}', {}, {}, '{}', '{}')",
                        id, tenant_id, proj_id, assignee_id, self.escape_string(&title),
                        priority, completed, created, created));
    ...
    fn write_folders<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for i in 0..folders_per_tenant {
                ...
                batch.push(format!("({}, {}, {}, '{}', '{}', '{}', '{}')",
                    id, tenant_id, parent_id, self.escape_string(&name), self.escape_string(&path),
                    created, created));
    ...
    fn write_comments<W: Write>(&mut self, w: &mut W, tenant_ids: &[i64]) -> io::Result<()> {
        ...
        for &tenant_id in tenant_ids {
            ...
            for i in 0..comments_per_tenant {
                ...
                batch.push(format!("({}, {}, {}, {}, '{}', {}, '{}', '{}', '{}')",
                    id, tenant_id, parent_id, user_id, commentable_type, commentable_id,
                    self.escape_string(&body), created, created));
    ...
    fn flush_batch<W: Write>(
        ...
        let (q, _) = self.quote_chars();
        let cols_str = columns.iter().map(|c| format!("{}{}{}", q, c, q)).collect::<Vec<_>>().join(", ");

        writeln!(w, "INSERT INTO {}{}{} ({}) VALUES", q, table_name, q, cols_str)?;
    ...
    fn format_bool(&self, b: bool) -> &'static str {
        match self.config.dialect {
            Dialect::MySql | Dialect::Sqlite => if b { "1" } else { "0" },
