...
async function captureScreenshots() {
  ...
  await page.screenshot({ path: 'screenshots/docs-default.png', fullPage: false });
  ...
  await page.screenshot({ path: 'screenshots/docs-dropdown-open.png', fullPage: false });
  ...
  await page.screenshot({ path: 'screenshots/docs-light-forced.png', fullPage: false });
  ...
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'screenshots/docs-dark-forced.png', fullPage: false });
  ...
  await page.waitForLoadState('networkidle');
  await page.screenshot({ path: 'screenshots/homepage-after-docs-dark.png', fullPage: false });
