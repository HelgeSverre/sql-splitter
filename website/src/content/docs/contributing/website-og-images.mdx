...
The website generates an OpenGraph image (1200x630px) for every documentation page, for sharing on social media. Each image includes:
...
OG images are generated using **Satori** and converted from SVG to PNG with **Sharp**.
