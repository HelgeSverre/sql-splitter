...
Formal JSON Schema files (draft 2020-12) are available in the [schemas/](https://github.com/helgesverre/sql-splitter/tree/main/schemas) directory for validation and code generation:

| Command | Schema File |
|---------|-------------|
| `analyze` | [analyze.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/analyze.schema.json) |
| `validate` | [validate.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/validate.schema.json) |
| `split` | [split.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/split.schema.json) |
| `merge` | [merge.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/merge.schema.json) |
| `sample` | [sample.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/sample.schema.json) |
| `convert` | [convert.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/convert.schema.json) |
| `redact` | [redact.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/redact.schema.json) |
| `graph` | [graph.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/graph.schema.json) |
| `shard` | [shard.schema.json](https://github.com/helgesverre/sql-splitter/blob/main/schemas/shard.schema.json) |
  ...
  "results": [
    {
      "input_file": "a.sql",
      "dialect": "mysql",
      "summary": { "total_tables": 15, "total_inserts": 50000, "total_bytes": 174762666 }
    }
  ]
}
```
