...
```json
{
  ...
  "failed": 0,
  "results": [
    { "file": "dumps/users.sql", "tables_count": 1, "total_inserts": 1000, "status": "success" },
    { "file": "dumps/orders.sql", "tables_count": 1, "total_inserts": 50000, "status": "success" }
  ]
}
```
...
```json
{
  ...
  "failed": 1,
  "results": [
    { "file": "a.sql", "passed": true, "summary": { "summary": { "errors": 0, "warnings": 0 } } },
    { "file": "b.sql", "passed": true, "summary": { "summary": { "errors": 0, "warnings": 1 } } },
    { "file": "c.sql", "passed": false, "summary": { "summary": { "errors": 2, "warnings": 0 } } }
  ]
}
```
