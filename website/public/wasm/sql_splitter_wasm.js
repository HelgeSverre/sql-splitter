...
const PlaygroundSessionFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_playgroundsession_free(ptr >>> 0, 1),
      );
...
export class PlaygroundSession {
  ...
  __destroy_into_raw() {
    ...
    this.__wbg_ptr = 0;
    PlaygroundSessionFinalization.unregister(this);
    return ptr;
  }
  free() {
  ...
  constructor(dump, dialect, on_progress) {
    try {
      ...
      this.__wbg_ptr = r0 >>> 0;
      PlaygroundSessionFinalization.register(this, this.__wbg_ptr, this);
      return this;
    } finally {
      wasm.__wbindgen_add_to_stack_pointer(16);
    }
  ...
  summary() {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.playgroundsession_summary(retptr, this.__wbg_ptr);
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
      var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
if (Symbol.dispose)
  PlaygroundSession.prototype[Symbol.dispose] =
    PlaygroundSession.prototype.free;
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_getRandomValues_e9de607763a970bd = function () {
    return handleError(function (arg0, arg1) {
      globalThis.crypto.getRandomValues(getArrayU8FromWasm0(arg0, arg1));
    }, arguments);
  };
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === "undefined") {
    module_or_path = new URL("sql_splitter_wasm_bg.wasm", import.meta.url);
  }
  const imports = __wbg_get_imports();
