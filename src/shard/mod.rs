...
"#
    ...
    fn test_parse_value_bytes() {
        assert_eq!(parse_value_bytes(b"123"), Some(PkValue::Int(123)));
        assert_eq!(parse_value_bytes(b"'hello'"), Some(PkValue::Text("hello".into())));
        assert_eq!(parse_value_bytes(b"NULL"), Some(PkValue::Null));
        assert_eq!(parse_value_bytes(b"null"), Some(PkValue::Null));
    }
    ...
    fn test_extract_column_value() {
        let row = b"(1, 'Alice', 5)";
        assert_eq!(extract_column_value(row, 0), Some(PkValue::Int(1)));
        assert_eq!(extract_column_value(row, 2), Some(PkValue::Int(5)));
    }
