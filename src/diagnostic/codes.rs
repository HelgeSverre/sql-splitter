...
define_diagnostics! {
    ...
    SEQUENCE_OUT_OF_RANGE, "GEN-SEQUENCE-OUT-OF-RANGE", "Sequence start is out of range", Generator, Error, "A sequence generator's start value does not fit the declared integer width of its column.";
